<div class="py-12 bg-[#1e212f] text-slate-100 min-h-[80vh]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <!-- Header -->
        <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
            <div>
                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#fff1f4]/15 text-[#ff527b] font-bold text-xs uppercase tracking-wider mb-2 border border-[#ff527b]/30">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div class="bg-[#282c3f] p-5 rounded-2xl border border-slate-700 shadow-lg">
            ...
            <div class="bg-[#282c3f] p-5 rounded-2xl border border-slate-700 shadow-lg">
                ...
                ?>
                <div class="text-2xl font-black text-[#ff3f6c]">₹<?php echo number_format($totalRev); ?></div>
            </div>
            <div class="bg-[#282c3f] p-5 rounded-2xl border border-slate-700 shadow-lg">
                <div class="text-slate-400 text-xs mb-1">AI Agents Online</div>
                <div class="text-2xl font-black text-[#03a685]">5 Specialists</div>
            </div>
        </div>
        ...
        <div class="mb-10 space-y-4">
            ...
            <div class="bg-[#282c3f] rounded-2xl border border-slate-700 overflow-x-auto shadow-xl">
                <table class="w-full text-left text-xs text-slate-300">
                    <thead class="bg-[#1e212f] text-slate-400 uppercase font-semibold text-[11px] border-b border-slate-700">
                        <tr>
                    ...
                    <tbody class="divide-y divide-slate-700">
                        <?php foreach ($orders as $o): ?>
                            <tr class="hover:bg-[#34384e] transition-colors">
                                <td class="p-4 font-bold text-[#ff527b]"><?php echo $o['order_id']; ?></td>
                                <td class="p-4">
                                ...
                                <td class="p-4">
                                    ...
                                    <div class="text-[11px] text-[#ff3f6c]">₹<?php echo number_format($o['amount']); ?></div>
                                </td>
                                <td class="p-4 text-amber-300 font-semibold"><?php echo $o['assigned_ca']; ?></td>
                                <td class="p-4">
                                    <span class="px-2.5 py-1 rounded-full text-[11px] font-bold bg-[#fff1f4]/15 text-[#ff527b] border border-[#ff527b]/30">
                                        <?php echo $o['status']; ?>
                                    </span>
                                </td>
                                <td class="p-4">
                                    <select onchange="updateStageAjax('<?php echo $o['order_id']; ?>', this.value)" class="bg-[#1e212f] border border-slate-600 text-white rounded-lg px-2.5 py-1 text-xs outline-none focus:border-[#ff3f6c]">
                    ...
                    <tbody class="divide-y divide-slate-700">
                        <?php foreach ($leads as $l): ?>
                            <tr class="hover:bg-[#34384e] transition-colors">
                                ...
                                <td class="p-4 text-[#ff527b]"><?php echo $l['phone']; ?></td>
                                <td class="p-4 text-white"><?php echo $l['service']; ?></td>
                                <td class="p-4 text-slate-400"><?php echo $l['city']; ?></td>
                                <td class="p-4">
                                    <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-[#e8fbf6]/20 text-[#03a685] border border-[#03a685]/30">
                                        <?php echo $l['status']; ?>
                                    </span>
                                </td>
                            </tr>
